...
rem C:\Python24\python setup.py bdist_egg register upload --identity="Andrew Carter" --sign --quiet
...
rem C:\Python26\python setup.py build_sphinx
rem C:\Python26\python setup.py upload_sphinx
pause